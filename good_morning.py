...
text = f'Generate a natural good morning message from this data: {dt} {forecast} {notifs}.  Round all measurements to the nearest integer. \
            ...
            Please incorporate a summary of the notifications in a natural format, with some description of their content. \
